...
export const projects = [
  ...
  shortDescription:
    "A simple movie recommendation engine built with Spring Boot and Spring AI that recommends movies using semantic similarity.",

  description:
    "WatchWise is a simple movie recommendation engine built with Spring Boot and Spring AI. It uses Google GenAI embeddings to represent movie information as vectors and find movies that are semantically similar to the user's query.",

  problemStatement:
    "The project was built to explore how vector embeddings and semantic similarity can be used to create a simple movie recommendation system.",

  architecture:
    "The application uses a Spring Boot backend with Spring AI and Google GenAI embeddings. Movie data is loaded from a JSON file and recommendations are generated by comparing embedding similarity.",
  ...
  engineeringDecisions: [
    "Used Spring AI to integrate embedding models with the Spring Boot application.",
    "Used vector embeddings to represent movie information semantically.",
    "Used similarity-based matching to find relevant movies.",
    "Separated the React frontend from the Spring Boot backend through REST APIs."
  ],

  github:
    "https://github.com/Ayansh252yadav/FDE/tree/main/WatchWise",

  liveDemo: null,

  metrics: {
    type: "Movie Recommendation Engine",
    backend: "Spring Boot / Java",
    frontend: "React",
...
},
 {
  ...
  tagline: "Real-Time AI Response Streaming",

  shortDescription:
    "A Spring Boot application that streams AI-generated responses using Spring AI and OpenAI.",

  description:
    "Streaming AI is a Spring Boot project built to explore real-time streaming of AI-generated responses. It uses Spring AI with OpenAI to generate and stream responses to the client instead of waiting for the complete response.",

  problemStatement:
    "The project was built to understand how AI responses can be streamed incrementally to improve the responsiveness of AI-powered applications.",

  architecture:
    "The application uses a Spring Boot backend integrated with Spring AI and OpenAI. The backend processes AI requests and streams generated responses to the client in real time.",
  ...
  engineeringDecisions: [
    "Used Spring AI to integrate OpenAI with the Spring Boot application.",
    "Used response streaming instead of waiting for the complete AI response.",
    "Separated the React frontend from the Spring Boot backend through API communication."
  ],

  github:
    "https://github.com/Ayansh252yadav/FDE/tree/main/StreamingLec5",

  liveDemo: null,

  metrics: {
    type: "AI Streaming Application",
    backend: "Spring Boot / Java",
    frontend: "React",
    ai: "Spring AI / OpenAI"
  }
